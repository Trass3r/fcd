...
bool hackhack_fillFromParamInfo(llvm::LLVMContext& ctx, ParameterRegistry& registry, CallInformation& info, bool returns, bool returnIsPtr, size_t integerLikeParameters, bool isVariadic);
