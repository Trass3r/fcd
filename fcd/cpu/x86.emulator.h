...
//extern "C" uint64_t x86_read_source_operand(CPTR(cs_x86_op) source, CPTR(x86_regs) regs);
//extern "C" uint64_t x86_read_destination_operand(CPTR(cs_x86_op) destination, CPTR(x86_regs) regs);
